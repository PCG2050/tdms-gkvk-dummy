...
namespace WebApi.Controllers.DataTables.FTI
{
    ...
    {
        private readonly IFtiProgramService _service;

        public FtiProgramController(IFtiProgramService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> AddResourcePerson(int contentId, [FromBody] FtiResourcePersonCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateResourcePerson(int personId, [FromBody] FtiResourcePersonUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddTopic(int contentId, [FromBody] FtiTopicsCoveredCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateTopic(int topicId, [FromBody] FtiTopicsCoveredUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddTeachingAid(int contentId, [FromBody] FtiTeachingAidsCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateTeachingAid(int aidId, [FromBody] FtiTeachingAidsUpdateDto dto)
        {
