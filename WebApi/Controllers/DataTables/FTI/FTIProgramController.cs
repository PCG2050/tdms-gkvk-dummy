// WebApi/Controllers/DataTables/FTI/FtiProgramController.cs
...
namespace WebApi.Controllers.DataTables.FTI
{
    ...
    public class FtiProgramController : ControllerBase
    {
        ...
        /// <summary>
        /// Create a new FTI program entry
        /// </summary>
        [HttpPost]
        ...
        public async Task<IActionResult> AddOrUpdateAdvisoryServices(int programId, [FromBody] FtiAdvisoryServicesCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateReport(int programId, [FromBody] FtiReportCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateRecommendation(int programId, [FromBody] FtiRecommendationCreateDto dto)
        {
        ...
        /// <summary>
        /// Search and filter FTI programs with pagination (Admin/UnitHead only)
        /// </summary>
        [HttpGet]
        [Authorize(Roles = $"{RoleString.UnitHead},{RoleString.Admin}")]
