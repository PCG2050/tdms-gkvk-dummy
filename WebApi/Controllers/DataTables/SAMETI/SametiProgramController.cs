// WebApi/Controllers/DataTables/SAMETI/SametiProgramController.cs
using Application.Models.DataTables.SAMETI;
using Application.Interface.Services.DataTables.SAMETI;

namespace WebApi.Controllers.DataTables.SAMETI
{
    [Authorize]
    [Route("api/stu/[controller]")]
    [ApiController]
    public class SametiProgramController : ControllerBase
    {
        private readonly ISametiProgramService _service;

        public SametiProgramController(ISametiProgramService service)
        {
            _service = service;
        }
        ...
        /// <summary>
        /// Create a new SAMETI program entry
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> CreateProgram([FromBody] SametiProgramCreateDto dto)
        {
        ...
        /// </summary>
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateProgram(int id, [FromBody] SametiProgramUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddDemographics(int programId, [FromBody] SametiParticipantDemographicsCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateDemographics(int demographicsId, [FromBody] SametiParticipantDemographicsUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddProgramContentWithChildren(int programId, [FromBody] SametiProgramContentWithChildrenCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateProgramContentWithChildren(int contentId, [FromBody] SametiProgramContentWithChildrenUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateAdvisoryServices(int programId, [FromBody] SametiAdvisoryServicesCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateReport(int programId, [FromBody] SametiReportCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateRecommendation(int programId, [FromBody] SametiRecommendationCreateDto dto)
        {
        ...
        /// <summary>
        /// Search and filter SAMETI programs with pagination (Admin/UnitHead only)
        /// </summary>
        [HttpGet]
