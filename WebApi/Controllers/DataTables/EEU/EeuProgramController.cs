...
namespace WebApi.Controllers.DataTables.EEU
{
    ...
    [ApiController]
    public class EeuProgramController : ControllerBase
    {
        private readonly IEeuProgramService _service;

        public EeuProgramController(IEeuProgramService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateProgram([FromBody] EeuProgramCreateDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateProgram(int id, [FromBody] EeuProgramUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddDemographics(int programId, [FromBody] EeuParticipantDemographicsCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateDemographics(int demographicsId, [FromBody] EeuParticipantDemographicsUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddResourcePerson(int contentId, [FromBody] EeuResourcePersonCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateResourcePerson(int personId, [FromBody] EeuResourcePersonUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddTopic(int contentId, [FromBody] EeuTopicsCoveredCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateTopic(int topicId, [FromBody] EeuTopicsCoveredUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddTeachingAid(int contentId, [FromBody] EeuTeachingAidsCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateTeachingAid(int aidId, [FromBody] EeuTeachingAidsUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddAdvisoryServices(int programId, [FromBody] EeuAdvisoryServicesCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateAdvisoryServices(int advisoryId, [FromBody] EeuAdvisoryServicesUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddReport(int programId, [FromBody] EeuReportCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateReport(int reportId, [FromBody] EeuReportUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddRecommendation(int programId, [FromBody] EeuRecommendationCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateRecommendation(int recommendationId, [FromBody] EeuRecommendationUpdateDto dto)
        {
