// WebApi/Controllers/DataTables/EEU/EeuProgramController.cs
...
namespace WebApi.Controllers.DataTables.EEU
{
    ...
    public class EeuProgramController : ControllerBase
    {
        ...
        /// <summary>
        /// Create a new EEU program entry
        /// </summary>
        [HttpPost]
        ...
        public async Task<IActionResult> AddOrUpdateAdvisoryServices(int programId, [FromBody] EeuAdvisoryServicesCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateReport(int programId, [FromBody] EeuReportCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateRecommendation(int programId, [FromBody] EeuRecommendationCreateDto dto)
        {
        ...
        /// <summary>
        /// Search and filter EEU programs with pagination (Admin/UnitHead only)
        /// </summary>
        [HttpGet]
        [Authorize(Roles = $"{RoleString.UnitHead},{RoleString.Admin}")]
