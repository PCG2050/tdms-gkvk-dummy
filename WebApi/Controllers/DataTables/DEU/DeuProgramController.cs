// WebApi/Controllers/DataTables/DEU/DeuProgramController.cs
...
namespace WebApi.Controllers.DataTables.DEU
{
    ...
    public class DeuProgramController : ControllerBase
    {
        ...
        /// <summary>
        /// Create a new DEU program entry
        /// </summary>
        [HttpPost]
        ...
        public async Task<IActionResult> AddOrUpdateAdvisoryServices(int programId, [FromBody] DeuAdvisoryServicesCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateReport(int programId, [FromBody] DeuReportCreateDto dto)
        {
        ...
        public async Task<IActionResult> AddOrUpdateRecommendation(int programId, [FromBody] DeuRecommendationCreateDto dto)
        {
        ...
        /// <summary>
        /// Search and filter DEU programs with pagination (Admin/UnitHead only)
        /// </summary>
        [HttpGet]
        [Authorize(Roles = $"{RoleString.UnitHead},{RoleString.Admin}")]
