...
namespace WebApi.Controllers.DataTables.DEU
{
    ...
    [ApiController]
    public class DeuProgramController : ControllerBase
    {
        private readonly IDeuProgramService _service;

        public DeuProgramController(IDeuProgramService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateProgram([FromBody] DeuProgramCreateDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateProgram(int id, [FromBody] DeuProgramUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddDemographics(int programId, [FromBody] DeuParticipantDemographicsCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateDemographics(int demographicsId, [FromBody] DeuParticipantDemographicsUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddResourcePerson(int contentId, [FromBody] DeuResourcePersonCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateResourcePerson(int personId, [FromBody] DeuResourcePersonUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddTopic(int contentId, [FromBody] DeuTopicsCoveredCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateTopic(int topicId, [FromBody] DeuTopicsCoveredUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddTeachingAid(int contentId, [FromBody] DeuTeachingAidsCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateTeachingAid(int aidId, [FromBody] DeuTeachingAidsUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddAdvisoryServices(int programId, [FromBody] DeuAdvisoryServicesCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateAdvisoryServices(int advisoryId, [FromBody] DeuAdvisoryServicesUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddReport(int programId, [FromBody] DeuReportCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateReport(int reportId, [FromBody] DeuReportUpdateDto dto)
        {
        ...
        public async Task<IActionResult> AddRecommendation(int programId, [FromBody] DeuRecommendationCreateDto dto)
        {
        ...
        public async Task<IActionResult> UpdateRecommendation(int recommendationId, [FromBody] DeuRecommendationUpdateDto dto)
        {
