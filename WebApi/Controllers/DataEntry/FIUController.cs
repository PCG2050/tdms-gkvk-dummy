...
//                .Include(a => a.FIUActivity) // Include the master data for activity type
...
//                var activityExists = await _context.Set<Domain.Entities.FIU.FIUActivity>()
...
//                FIUActivitiesId = activityDto.FIUActivitiesId ?? 0,
//                Number = activityDto.Number ?? 0,
...
//            // Update fields
//            existing.FIUActivitiesId = activityDto.FIUActivitiesId ?? 0;
//            existing.Number = activityDto.Number ?? 0;
...
//                var activityTypes = await _context.Set<Domain.Entities.FIU.FIUActivity>()
