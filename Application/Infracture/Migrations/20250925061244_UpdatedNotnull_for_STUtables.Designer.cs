...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250925061244_UpdatedNotnull_for_STUtables")]
    partial class UpdatedNotnull_for_STUtables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ConsultingAndSocialMediaService.TableConsultingAndSocialMediaService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Fk_ModeOrOutageId")
                        .HasColumnType("int");

                    b.Property<int>("Fk_Particulars")
                        .HasColumnType("int");

                    b.Property<int>("Fk_RelatedToDeciplineId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RelatedToDeciplineOther")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("Domain.Entities.ConsultingAndSocialMediaService.TableModeAndOutage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FK_ConsultingServiceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.DEU.DeuRecommendation", b =>
                {
                    ...
                    b.ToTable("DeuRecommendation", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.DEU.DeuResourcePerson", b =>
                {
                    ...
                    b.ToTable("DeuResourcePerson", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.EEU.EeuRecommendation", b =>
                {
                    ...
                    b.ToTable("EeuRecommendation", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.EEU.EeuResourcePerson", b =>
                {
                    ...
                    b.ToTable("EeuResourcePerson", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.FIU.FIUAdvisoryServices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FIUProgramDetailsID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FIUProgramDetailsID");

                    b.HasIndex("UpdatedById");

                    b.ToTable("FIUAdvisoryServices");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUParticipantDemographics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIUParticipantDemographics");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUProgramContentAndResources", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIUProgramContentAndResources");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUProgramDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIUProgramDetails");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIURecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIURecommendations");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIUReports");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUResourcePerson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FIUProgramContentAndResourcesID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FIUProgramContentAndResourcesID");

                    b.HasIndex("UpdatedById");

                    b.ToTable("FIUResourcePersons");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUTeachingAidsDeveloped", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIUTeachingAidsDeveloped");
                });

            modelBuilder.Entity("Domain.Entities.FIU.FIUTopicsCoveredInClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FIUTopicsCoveredInClass");
                });
            ...
            modelBuilder.Entity("Domain.Entities.IBTVA.IbtvaRecommendation", b =>
                {
                    ...
                    b.ToTable("IbtvaRecommendation", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.IBTVA.IbtvaResourcePerson", b =>
                {
                    ...
                    b.ToTable("IbtvaResourcePerson", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Service.RevolvingFundStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Service.TableHostel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VillageOrTaluq")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Domain.Entities.Service.TblService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Fk_Catogory")
                        .HasColumnType("int");

                    b.Property<int>("Fk_SourceOfFund")
                        .HasColumnType("int");

                    b.Property<int>("Fk_Theme")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OtherCatogory")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Domain.Entities.ConsultingAndSocialMediaService.TableConsultingAndSocialMediaService", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ConsultingAndSocialMediaService.TableModeAndOutage", "ModeOrOutage")
                        .WithMany("ConsultingServices")
                        .HasForeignKey("ModeOrOutageId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.FIU.FIUAdvisoryServices", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FIU.FIUProgramDetails", "ProgramDetails")
                        .WithMany("AdvisoryServices")
                        .HasForeignKey("FIUProgramDetailsID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.FIU.FIUResourcePerson", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FIU.FIUProgramContentAndResources", "ProgramContentAndResources")
                        .WithMany("ResourcePersons")
                        .HasForeignKey("FIUProgramContentAndResourcesID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Service.RevolvingFundStatus", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Service.TblService", "TblService")
