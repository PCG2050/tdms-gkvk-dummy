...
namespace Infrastructure.Services.DataTables.DEU
{
    public class DeuProgramService : IDeuProgramService
    {
        ...
        public async Task<ServiceResult<DeuProgramDetailsDto>> UpdatePendingProgramByUnitHeadAsync(int id, DeuProgramUpdateDto dto)
        {
            var program = await _programRepository.GetWithDetailsAsync(id);
            ...
            int? trainerId = null)
        {
            ...
            {
                result = new PaginatedResult<DeuProgramDetails>(
        ...
        public async Task<PaginatedResult<DeuProgramDetailsDto>> GetFormsByTrainerAsync(
            int trainerId,
            int pageNumber = 1,
            int pageSize = 10)
        {
        ...
        public async Task<PaginatedResult<DeuProgramDetailsDto>> GetHistoryAsync(
            string historyType,
            int pageNumber = 1,
            int pageSize = 10,
            int? userId = null,
            int? unitLocationId = null)
        {
            ...
            List<DeuProgramDetails> filteredItems;
