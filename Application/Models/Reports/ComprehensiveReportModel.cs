...
namespace Application.Models.Reports
{
    ...
    public class ComprehensiveReportRequest
    {
        ...
        /// <summary>
        /// Quarter (1-4) - Required for quarterly reports
        ...
        /// Key: sectionKey (e.g., "program_organized"), Value: list of field keys
        /// </summary>
        public Dictionary<string, List<string>>? SelectedFields { get; set; }
    }
