...
namespace Application.Models.DataTables.SAMETI
{
    // ==================== PROGRAM DETAILS (Section A) ====================
    public class SametiProgramDetailsDto
    {
    ...
    public class SametiProgramCreateDto
    {
        [Required]
        public int UnitLocationId { get; set; }
        public DateOnly StartDate { get; set; }
    ...
    public class SametiProgramUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public DateOnly StartDate { get; set; }
        public DateOnly EndDate { get; set; }
   ...
   public class SametiProgramCompleteDto
    {
        public SametiProgramDetailsDto ProgramDetails { get; set; }
        public List<SametiParticipantDemographicsDto>? Demographics { get; set; }
        public List<SametiProgramContentDto>? ProgramContent { get; set; }
        public SametiAdvisoryServicesDto? AdvisoryServices { get; set; }
     
        public SametiReportDto? Report { get; set; } // For other categories
        public SametiRecommendationDto? Recommendation { get; set; }
    }
    /// <summary>
    /// Lightweight DTO for list/search results
    /// </summary>
    public class SametiProgramListItemDto
    {
        public int Id { get; set; }
        public string? Title { get; set; }
        public DateOnly StartDate { get; set; }
    ...
    public class SametiParticipantDemographicsDto
    {
        public int Id { get; set; }
    ...
    public class SametiParticipantDemographicsCreateDto
    {
        public int? ParticipantId { get; set; }
        public int? Male_SC { get; set; }
        public int? Male_ST { get; set; }
    ...
    public class SametiParticipantDemographicsUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public int? ParticipantId { get; set; }
        public int? Male_SC { get; set; }
   ...
   // ============================
    ...
    // ============================
    public class SametiProgramContentDto
    {
        public int Id { get; set; }
        public int SametiProgramDetailsId { get; set; }
        public string? Title { get; set; }
        public string? Description { get; set; }
        public List<SametiResourcePersonDto>? ResourcePersons { get; set; }
        public List<SametiTopicsCoveredDto>? TopicsCovered { get; set; }
        public List<SametiTeachingAidsDto>? TeachingAids { get; set; }
    }

    public class SametiProgramContentCreateDto
    {
        public string? Title { get; set; }
        public string? Description { get; set; }
    }
    ...
    /// <summary>
    /// Composite DTO for creating SametiProgramContentAndResources along with all child entities in a single transaction
    /// </summary>
    public class SametiProgramContentWithChildrenCreateDto
    {
        // Parent fields
        public string? Title { get; set; }
        public string? Description { get; set; }
        ...
        public List<SametiResourcePersonCreateDto>? ResourcePersons { get; set; }
        public List<SametiTopicsCoveredCreateDto>? TopicsCovered { get; set; }
        public List<SametiTeachingAidsCreateDto>? TeachingAids { get; set; }
    }
    ...
    /// </summary>
    public class SametiResourcePersonHybridDto
    {
    ...
    /// </summary>
    public class SametiTopicsCoveredHybridDto
    {
        public int? Id { get; set; }  // null = create new, has value = update existing
    ...
    /// </summary>
    public class SametiTeachingAidsHybridDto
    {
        public int? Id { get; set; }  // null = create new, has value = update existing
    ...
    /// <summary>
    /// Composite DTO for updating SametiProgramContentAndResources with all child entities in a single transaction
    /// Uses Hybrid Pattern:
    /// - Items WITH Id: UPDATE existing
    /// - Items WITHOUT Id: CREATE new
    /// - Items in DB but NOT in arrays: DELETE
    /// </summary>
    public class SametiProgramContentWithChildrenUpdateDto
    {
        // Parent fields
        public string? Title { get; set; }
        public string? Description { get; set; }
        ...
        public List<SametiResourcePersonHybridDto>? ResourcePersons { get; set; }
        public List<SametiTopicsCoveredHybridDto>? TopicsCovered { get; set; }
        public List<SametiTeachingAidsHybridDto>? TeachingAids { get; set; }
    }

    // Resource Person DTOs
    public class SametiResourcePersonDto
    {
        public int Id { get; set; }
        public string? Name { get; set; }
        public string? Designation { get; set; }
    ...
    public class SametiResourcePersonCreateDto
    {
        public string? Name { get; set; }
        public string? Designation { get; set; }
        public int? ResourceTypeId { get; set; }
    ...
    public class SametiResourcePersonUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public string? Name { get; set; }
        public string? Designation { get; set; }
    ...
    // Topics Covered DTOs
    public class SametiTopicsCoveredDto
    {
        public int Id { get; set; }
        public DateTime? Date { get; set; }
        public string? Title { get; set; }
    ...
    public class SametiTopicsCoveredCreateDto
    {
        public DateTime? Date { get; set; }
        public string? Title { get; set; }
        public string? PhotoUpload { get; set; }
    ...
    public class SametiTopicsCoveredUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public DateTime? Date { get; set; }
        public string? Title { get; set; }
    ...
    // Teaching Aids DTOs
    public class SametiTeachingAidsDto
    {
        public int Id { get; set; }
        public int? TypeOfAidId { get; set; }
    ...
    public class SametiTeachingAidsCreateDto
    {
        public int? TypeOfAidId { get; set; }
        public string? OtherTypeOfAid { get; set; }
        public string? Purpose { get; set; }
    ...
    public class SametiTeachingAidsUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public int? TypeOfAidId { get; set; }
        public string? OtherTypeOfAid { get; set; }
    ...
    // ============================
    public class SametiAdvisoryServicesDto
    {
        public int Id { get; set; }
    ...
    public class SametiAdvisoryServicesCreateDto
    {
        public int? NoOfFacebookSMS { get; set; }
        public int? NoOfSMSSentToRegisteredFarmers { get; set; }
        public int? NoOfWhatsappGroups { get; set; }
    ...
    public class SametiAdvisoryServicesUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public int? NoOfFacebookSMS { get; set; }
        public int? NoOfSMSSentToRegisteredFarmers { get; set; }
    ...
    public class SametiReportCreateDto
    {
    ...
    public class SametiReportUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
    ...
    public class SametiRecommendationDto
    {
        public int Id { get; set; }
    ...
    public class SametiRecommendationCreateDto
    {
        public string? ProblemsIdentified { get; set; }
        public string? Recommendation { get; set; }
        public string? ActionTaken { get; set; }
    ...
    public class SametiRecommendationUpdateDto : IUpdateDto
    {
        public int Id { get; set; }
        public string? ProblemsIdentified { get; set; }
        public string? Recommendation { get; set; }
