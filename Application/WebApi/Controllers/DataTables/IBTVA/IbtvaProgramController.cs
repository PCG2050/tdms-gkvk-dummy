...
namespace WebApi.Controllers.DataTables.IBTVA
{
    ...
    public class IbtvaProgramController : ControllerBase
    {
        ...
        /// <summary>
        /// Creates a new IBTVA program
        /// </summary>
        /// <remarks>
        /// Developer Notes:
        /// Use these endpoints for current KVK module development:
        /// - POST /api/IbtvaProgram (create program)
        /// - PUT /api/IbtvaProgram/{id} (update program)
        /// - GET /api/IbtvaProgram/{id} (get single program)
        /// - GET /api/IbtvaProgram/{id}/complete (get program with all related data)
        /// - DELETE /api/IbtvaProgram/{id} (delete program)
        /// </remarks>
        [HttpPost]
        ...
        /// - POST /api/IbtvaProgram/{programId}/content-with-children (create content with all children)
        /// - PUT /api/IbtvaProgram/content/{contentId}/with-children (update content with all children)
        /// - GET /api/IbtvaProgram/content/{contentId} (get content)
        /// - DELETE /api/IbtvaProgram/content/{contentId} (delete content)
        ///
