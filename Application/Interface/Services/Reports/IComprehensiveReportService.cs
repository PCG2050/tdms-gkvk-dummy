...
namespace Application.Interface.Services.Reports
{
    ...
    public interface IComprehensiveReportService
    {
        ...
        /// <summary>
        /// Get report configuration including available sections and fields for a unit
        /// </summary>
        /// <param name="unitId">Unit ID to get configuration for</param>
        /// <returns>Report configuration with available sections and fields</returns>
        Task<ServiceResult<ReportConfigurationResponse>> GetReportConfigurationAsync(int unitId);
    }
}
