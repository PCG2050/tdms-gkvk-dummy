...
namespace Infrastructure.Services.DataTables.EEU
{
    public class EeuProgramService : IEeuProgramService
    {
        ...
        /// </summary>
        public async Task<PaginatedResult<EeuProgramDetailsDto>> GetByTrainerAsync(
            int trainerId,
            int? unitLocationId = null,
            int pageNumber = 1,
            int pageSize = 10)
        ...
        /// </summary>
        public async Task<PaginatedResult<EeuProgramDetailsDto>> GetUnifiedHistoryAsync(
            int? trainerId = null,
            int? unitLocationId = null,
            int pageNumber = 1,
            int pageSize = 10)
