...
//{
//    public class EeuOftService : GenericTableService<EeuOFT, EeuOftCreateDto, EeuOftUpdateDto, EeuOftDto>, IEeuOftService
//    {
//        public EeuOftService(IEeuOftRepository repository, ICurrentUserService currentUserService, IEntityPermissionService entityPermissionService) : base(repository, currentUserService, entityPermissionService)
//        {
//        }

//        protected override Task<EeuOFT> MapCreateDtoToEntityAsync(EeuOftCreateDto createDto)
//        {
//            var entity = new EeuOFT
//            {
...
//        protected override Task MapUpdateDtoToEntityAsync(EeuOftUpdateDto updateDto, EeuOFT entity)
//        {
