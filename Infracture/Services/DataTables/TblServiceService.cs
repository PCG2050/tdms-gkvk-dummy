...
namespace Infrastructure.Services.DataTables
{
    public class TblServiceService : ITblServiceService
    {
        ...
        public async Task<ServiceResult<TblServicesDto>> CreateAsync(TblServiceCreateDto createDto)
        {
            ...
            // Handle child entities if provided (matching PUT method approach)
            // Create TableHostel children if provided
            ...
            // Create RevolvingFundStatus children if provided
            ...
            // Create VisitorDetail children if provided
