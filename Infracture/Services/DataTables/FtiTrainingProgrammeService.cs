...
//{
//    public class FtiTrainingProgrammeService : GenericTableService<FtiTrainingProgram, FtiTrainingProgrammeCreateDto, FtiTrainingProgrammeUpdateDto, FtiTrainingProgram>,IFtiTrainingProgrammeService
//    {
...
//        {
//        }
//        protected override Task<FtiTrainingProgram> MapCreateDtoToEntityAsync(FtiTrainingProgrammeCreateDto createDto)
//        {
//            var entity = new FtiTrainingProgram
//            {
...
//        protected override Task MapUpdateDtoToEntityAsync(FtiTrainingProgrammeUpdateDto updateDto, FtiTrainingProgram entity)
//        {
...
//            if (updateDto.OrganisationName is not null) entity.OrganisationName = updateDto.OrganisationName;
