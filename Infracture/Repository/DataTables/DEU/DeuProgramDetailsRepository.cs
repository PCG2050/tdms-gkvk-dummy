// DeuProgramDetailsRepository.cs
...
{
    public class DeuProgramDetailsRepository : IDeuProgramDetailsRepository
    {
        ...
        public async Task<DeuProgramDetails?> GetByIdAsync(int id)
        {
            return await _context.DeuProgramDetails.FindAsync(id);
        }

        public async Task<DeuProgramDetails?> GetWithDetailsAsync(int id)
        {
            return await _context.DeuProgramDetails
        ...
        public async Task<DeuProgramDetails> CreateAsync(DeuProgramDetails entity)
        {
            _context.DeuProgramDetails.Add(entity);
            await _context.SaveChangesAsync();
            return await GetWithDetailsAsync(entity.Id) ?? entity;
        }

        public async Task<DeuProgramDetails> UpdateAsync(DeuProgramDetails entity)
        {
            _context.DeuProgramDetails.Update(entity);
            await _context.SaveChangesAsync();
            return entity;
        }
        ...
        {
            var entity = await _context.DeuProgramDetails.FindAsync(id);
            if (entity != null)
            {
                _context.DeuProgramDetails.Remove(entity);
                await _context.SaveChangesAsync();
            }
        }

        public async Task<PaginatedResult<DeuProgramDetails>> GetPaginatedAsync(
        ...
        {
            var query = _context.DeuProgramDetails
                .Include(p => p.ProgramType)
                .Include(p => p.Category)
                .Include(p => p.Mode)
                .Include(p => p.Region)
            ...
            return new PaginatedResult<DeuProgramDetails>(items, totalItems, pageNumber, pageSize);
        }

        public async Task<PaginatedResult<DeuProgramDetails>> GetByStatusAsync(
            List<int> unitLocationIds,
            string status,
            int pageNumber = 1,
            int pageSize = 10)
