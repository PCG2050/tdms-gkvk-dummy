...
{
    public class AticProgramDetails : ReportEntryBaseEntity
    {
        ...
        public AticAdvisoryServices? AdvisoryServices { get; set; }
        public AticRecommendation? Recommendations { get; set; }
        public AticReport? Reports { get; set; }
