...
{
    public  class TableKVKProgramDetails : AuditableBaseEntity
    {
        ...
        public ICollection<KvkRecommendation> Recommendations { get; set; }

        public ICollection<KvkReport> Reports { get; set; }

        public ICollection<KvkAdvisoryServices> AdvisoryServices { get; set; }
